	...
	function gluu_openid_save_settings(){
		...
		if( isset( $_POST['option'] ) and $_POST['option'] == "oxd_openid_connect_register_site_oxd" ) {
			...
			if(gluu_is_oxd_registered()) {
				...
				update_option('gluu_gluu_oxd_openid_default_login_enable', isset( $_POST['oxd_openid_default_login_enable']) ? $_POST['oxd_openid_default_login_enable'] : 0);
				update_option('gluu_oxd_openid_default_register_enable', isset( $_POST['oxd_openid_default_register_enable']) ? $_POST['oxd_openid_default_register_enable'] : 0);
				...
				update_option('gluu_oxdOpenId_user_attributes', isset( $_POST['oxdOpenId_user_attributes']) ? $_POST['oxdOpenId_user_attributes'] : 0);
				$this->gluu_oxd_openid_show_success_message();
			} else {
				update_option('gluu_oxd_openid_message', 'Please register an account before trying to enable any app');
				$this->gluu_oxd_openid_show_error_message();
